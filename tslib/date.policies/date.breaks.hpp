...
namespace tslib {
  ...
  void YearlyBreaks(T beg, T end, COLL<TSDIM>& coll) {
    ...
    while(beg != (end - 1) ) {
      ...
      if(DatePolicy<value_type>::year(*beg) != DatePolicy<value_type>::year(*next) ) {
...
void QuarterlyBreaks(T beg, T end, COLL<TSDIM>& coll) {
  ...
  void MonthlyBreaks(T beg, T end, COLL<TSDIM>& coll) {
    ...
    while(beg != (end - 1) ) {
      ...
      if(DatePolicy<value_type>::month(*beg) != DatePolicy<value_type>::month(*next) ||
         DatePolicy<value_type>::year(*beg) != DatePolicy<value_type>::year(*next) ) {
        back_inserter(coll) = i;
      }
      ++i;
  ...
  void WeeklyBreaks(T beg, T end, COLL<TSDIM>& coll) {
    ...
    while(beg != (end - 1) ) {
      ...
      if(DatePolicy<value_type>::dayofweek(*beg) > DatePolicy<value_type>::dayofweek(*next) ||
